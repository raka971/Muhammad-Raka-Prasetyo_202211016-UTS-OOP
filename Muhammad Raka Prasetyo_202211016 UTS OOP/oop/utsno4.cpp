...
int main() {
    ...
    Mahasiswa mahasiswa("Deri Afandi", "202211008");
    ...
    mahasiswa.tambahMataKuliah("Matematika");
    mahasiswa.tambahMataKuliah("Webpro");
    mahasiswa.tambahMataKuliah("Bahasa Inggris");
    mahasiswa.tampilkanCatatanAkademik();

    // Input nilai untuk mata kuliah tertentu dan menampilkan catatan akademik setelahnya
    mahasiswa.inputNilai("Matematika", 75.0);
    mahasiswa.inputNilai("Webpro", 90.0);
    mahasiswa.inputNilai("Bahasa Inggris", 85.0);
    mahasiswa.tampilkanCatatanAkademik();

    // Menghapus mata kuliah dan menampilkan catatan akademik setelahnya
    mahasiswa.hapusMataKuliah("Matematika");
    mahasiswa.tampilkanCatatanAkademik();
